...
export function SampleWorkspaceDialog({
  ...
  return (
    <ConfirmDialog
      ...
      message="MyEFvibe Studio can download the AdventureWorks SQLite sample (including a starter database), wire up scripts and extra usings, and open starter queries — LINQ, SQL, comparisons, benchmarks, full C# programs, and a notebook."
      detail={detail}
